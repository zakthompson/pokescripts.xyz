	...
	switch (state)
	{
		case PROCESS:
			...
			if (commandIndex == -1)
			{
				...
				{
					if (commandSequence < 30)
					{
						commandSequence++;
						if (commandSequence%30 == 0)
						{
							commandIndex = 21;
							m_endIndex = (loop == 2) ? 30 : 50;
						} else if (commandSequence%6 == 0) //6,12,18,24
						{
							commandIndex = 17;
							m_endIndex = 18;
						} else if ((commandSequence/6)%2 == 0) // 1-5, 13-17, 25-29
						{
							commandIndex = 15;
							m_endIndex = 16;
						} else if ((commandSequence/6)%2 == 1) // 7-11, 19-23
						{
							commandIndex = 19;
							m_endIndex = 20;
						}
